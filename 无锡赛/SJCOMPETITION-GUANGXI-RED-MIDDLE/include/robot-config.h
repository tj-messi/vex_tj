...
extern double set_convey_belt_spin_time;        // 用在自动函数convey_belt_spin_for_time中的参数,单位：秒
extern bool start_convey_belt_spin_for_time; // 用在自动函数convey_belt_spin_for_time中的参数
/*************************************
...
extern rotation roller_group_rotation;
