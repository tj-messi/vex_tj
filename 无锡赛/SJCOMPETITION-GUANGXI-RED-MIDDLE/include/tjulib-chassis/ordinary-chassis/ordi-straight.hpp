...
namespace tjulib
{
    ...
    public:
        ...
        void moveInches(T inches, T maxSpeed, double maxtime_ms = 5000, int fwd = 1){
            ...
            {
                // printf("error1: %lf error2: %lf \n",position->LeftBaseDistance, position->RightBaseDistance);
        ...
        void turnToTarget(Point target, T maxSpeed, double maxtime_ms, int fwd){
            ...
            turnToAngle(Math::getWrap360(getDegree(target)+imu.angle()), maxSpeed, maxtime_ms, fwd);
        }
        ...
        void moveToTarget(Point target, T maxFwdSpeed, T maxTurnSpeed, double maxtime_ms, int fwd)
        {
            ...
            moveInches(GetDistance(target), maxFwdSpeed, maxtime_ms / 2, fwd);
            return;
